        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              A passionate frontend developer focused on creating intuitive and engaging user experiences with modern web technologies.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Subscribe to receive updates and news about my latest projects.</p>
            <div className="flex">
              <input 
                type="email" 
                placeholder="Your email" 
                className="px-4 py-2 w-full rounded-l-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-gray-800"
              />
              <button className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-4 py-2 rounded-r-md hover:from-purple-700 hover:to-indigo-700 transition-colors duration-300">
                Join
              </button>
            </div>
          </div>
